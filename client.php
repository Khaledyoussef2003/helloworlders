...
<style>
    ...
    * {
    ...
    .home {
        ...
        align-items: center;
        min-height: 100vh;
        background: url(images/44.webp)no-repeat;
    ...
    /* .products .box-container .box .content .quantity {
            font-size: 2.5rem;
            color: #e84393;
            font-weight: bolder;
            padding-top: 2rem;
...
<body>
    <header>
        ...
        <a href="#" class="logo">
        <img src="images/flower.jpg" alt="Flower Shop Logo" style="height:60px;">Flower Shop
         </a>
        ...
        <div class="icons">
            ...
            <a href="shopping2.php" class="fas fa-shopping-cart"><span id="shopping"><?php echo $count ;?></span></a>
            <a href="" class="fas fa-user"></a>
            <!-- <a href="#" class="fas fa-moon" id="darkmode"></a> -->
            <a href='logout.php' class="fas fa-out">
                <span>Logout</span>
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            <div class="video-container">
                <video src="images/about vid.mp4.mov" loop autoplay muted></video>
        ...
        <div class="box-container">
            ...
            if(isset($_GET['search']) && !empty($_GET['search'])) {
                ...
                foreach($result as $row) {
                    $productName = strtolower($row['name']); // Convert product name to lowercase
                    
                    // Check if the exact search string exists in the product name
                ...
                echo " <div class='box-container'> 
                        <div class='box'>
                            ...
                            <img src='images/$image'>
                                    <div class='icons'>
                                        <a href='shopping.php?id=$id' class='cart-btn'>add to cart</a>
                                    </div>
                            </div>
                                <div class='content'>
                                <h3>" . $name . "</h3>
                ...
                <div class="box-container">
                    <div class="box">
                        ...
                        <p>” Very friendly admin staff and very accommodating to fit my request on a rather late
                            ...
                            definitely
                            come back again and will not hesitate to recommend your good shop to others. Keep it up!
                            God
                            Bless.”</p>
                        <div class="user">
                    ...
                    <div class="box">
                        ...
                        <p>“I really would like to thank Sondos for listening to all my needs and changing them for
                            me.
                            She even showed samples for me to choose from. Sondos is really patient & a friendly
                            seller,
                            no doubt I would deal with her again in the future.thank you so much, I am sure my
                            friend
                    ...
                    <div class="box">
                        ...
                        <p> “I am very happy that Fresh Flowers marketing dep followed me
                            and I get to know this friendly and very helpful Fresh Flowers. The founder happen to
                            pick
                            up my call,
                            reminded to check what time the recipient discharge from the hospital so as to avoid
                            change
                            of
                            location delivery charges.Overall, we are happy and we like the beautiful flowers
                            basket!
                            Good!”</p>
                        <div class="user">
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            <form action="sendemail.php" method="POST">
                ...
                <input type="email" name="toemail" placeholder="TO email" class="box">
                <input type="email" name="fromemail" placeholder="From email" class="box">
    ...
    <section class="footer" id="footer">
        <div class="box-container">
            ...
            <div class="box">
                <h3>extra links</h3>
                <a href="#">My account</a>
                <a href="shopping2.php">My order</a>
            ...
            <div class="box">
                ...
                <!-- <img src="../IMG212.webp" alt="" width="50" height="50">   -->
            </div>
        </div>
